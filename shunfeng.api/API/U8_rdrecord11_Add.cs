...
{
    public class U8_rdrecord11_Add
    {
        public bool U8_rdrecord11(rdrecord11 main, List<rdrecords11> detailList, out string resultmsg)
        {
            ...
            DomHead[0]["bmotran"] = ""; //自动编号，string类型
            ...
            foreach (var item in detailList)
            {
                ...
                domBody[0]["cinvcode"] = item.cInvCode; //材料编码，string类型
                ...
                domBody[0]["invstd"] = ""; //产品规格，string类型
