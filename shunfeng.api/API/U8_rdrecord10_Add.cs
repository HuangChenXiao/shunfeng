...
{
    public class U8_rdrecord10_Add
    {
        public bool U8_rdrecord10(rdrecord10 main,List<rdrecords10> detailList,out string resultmsg) 
        {
            ...
            DomHead[0]["crdcode"] = main.cRdCode; //入库类别编码，string类型
            ...
            domBody[0]["cinvcode"] =item.cInvCode; //产品编码，string类型
            ...
            domBody[0]["iinvsncount"] = ""; //已指定序列号量，string类型
            domBody[0]["cmocode"] = item.cmocode; //生产订单号，string类型
            domBody[0]["imoseq"] = item.imoseq; //生产订单行号，string类型
