...
{
    public class U8_RdRecord08_Add
    {
        public bool U8_RdRecord08(RdRecord08 main,List<rdrecords08> detailList,out string resultmsg)
        {
            ...
            DomHead[0]["cvencode"] = ""; //供应商编码，string类型
            ...
            domBody[0]["coritracktype"] = ""; //预留原始跟踪号类型，string类型
            ...
            domBody[0]["itrids"] = ""; //其他业务AUTOID，double类型
